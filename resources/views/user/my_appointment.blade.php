...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{url('myappointment')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline">My Appointment</a>
      <x-app-layout>
      </x-app-layout>  
  ...
  <table class="table mt-4">
    ...
    @foreach($appoint as $appoints)
      <tr>
        ...
        <td><a href="{{'cancel_appoint',$appoints->id}}" type="button" class="btn btn-outline-danger btn-sm">Cancel</a></td>
      </tr>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div class="credits">
          Designed by <a href="https://bootstrapmade.com/">Mr. Manish Bisen</a>
        </div>
      </div>
